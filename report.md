...
| /\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*
 ...
 \*\*-----------------------------------------------------------------------------
 \*\* bjg019 30-Dec-2009 LIBtt54238 Implement +MIPCLOSE response as unsolicited response, after socket was removed from time wait list.
 \*\* brz018 08-Dec-2009 LIBtt41180 Report +FTPCLOSE only after receiving CLOSE event.
 \*\* ----------------------------------------------------------------------------- \*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*/ |
```
